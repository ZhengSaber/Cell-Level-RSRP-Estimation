...
def inference_UNet(data,generator,ep=0, Save_Result=False, save_dir_name=None):
...
if __name__=='__main__':
    ...
    # test_data = ult.read_dataset(dataset_path, 'trainset.npy')
    ...
    generator.load_weights("./model/UNet/generator")
    ...
    for i in range(len(test_data)):
        ...
        # if i <= 10:
        rmse, mape, ssim,psnr = inference_UNet(test_data[i],
                                    generator,)
